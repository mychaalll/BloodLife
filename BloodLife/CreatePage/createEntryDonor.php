<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      else
      {
        ...
        $_SESSION['status'] = "Donor entry was created successfully.";
    ...
    <div class="content">
      ...
      <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" class = "middle-name" name = "entry-middle-name" placeholder="Enter Middle name.">
          </div>
          <div class="input-box">
          ...
          <div class="text-area">
            ...
            <textarea class = "comments" name = "entry-contact-details" placeholder = "Add Contact Details here." rows = "10" cols = "30" required></textarea>
          </div>
          <div class="text-area">
