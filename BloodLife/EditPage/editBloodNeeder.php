<?php
  ...
  {
    $location = "../AdminPage/adminNeeders.php";
  }

  $query = "SELECT FirstName,MiddleName,LastName,BloodType,FullAddress,City,Region,ContactDetails,Comments FROM needertable where ID = '$ID' ";
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    else
    {
      ...
      //save to database;
      $query = "UPDATE `needertable` SET `FirstName`='$first_name',`MiddleName`='$middle_name',`LastName`='$last_name',`BloodType`='$blood_needed',`FullAddress`='$full_address',`City`='$city',`Region`='$region',`ContactDetails`='$contact_details',`Comments`='$comments' WHERE ID = $ID";
      mysqli_query($con, $query);
      $_SESSION['status'] = "Recipient entry was updated.";
