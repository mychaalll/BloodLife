    ...
    <body>
        <section>
                ...
                <nav>
                    ...
                    <div class = "navigation">
                        <ul>
                            ...
                            <li><a class ="sbn" href="#">Blood Recipient</a></li>
            ...
            <div class = "content" id = "content">
                <!-- Needer Page -->
                <div class = "bloodNeederPage" id = "bloodNeederPage">
                    <h1>Table of Blood Needers</h1><br>
                    <table class = "adminTables">
                        ...
                        echo "<thead>
                            ...
                            <th class = 'donor-table-header-creatorID'><a class = 'bt' href = '?order=CreatorID&&sort=$sort' id = 'table-header' ><i class='fa fa-sort' aria-hidden='true'></i> Creator ID</a></th>
                            <th class = 'donor-table-header-name'><a class = 'bt' href = '?order=LastName&&sort=$sort' id = 'table-header' ><i class='fa fa-sort' aria-hidden='true'></i> Name</a></th>
                            <th class = 'donor-table-header-bloodType'><a class = 'bt' href = '?order=BloodType&&sort=$sort' id = 'table-header' ><i class='fa fa-sort' aria-hidden='true'></i> Blood Needed</a></th>
                            ...
                            <th class = 'donor-table-header-date'><a class = 'bt' href = '?order=Date&&sort=$sort' id = 'table-header' class = 'date'><i class='fa fa-sort' aria-hidden='true'></i>Date</a></th>
                            <th class = 'donor-table-header-comments'><t href = '#' id = 'table-header' class = 'comments' >Comments</t></th>
                            <th class = 'donor-table-header-actions'><t href = '#' id = 'table-header' ></t></th>
                            </tr>
                        </thead><tbody>";
                            
                            
                        $query = "SELECT ID,CreatorID,FirstName,MiddleName,LastName,BloodType,FullAddress,City,Region,ContactDetails,Date,Comments FROM needertable WHERE Status != 'deleted' ORDER BY $order $sort";
                        ...
                        if ($result && mysqli_num_rows($result) > 0)
                        {
                            while ($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                echo "<a class = 'table-edit' href = '../EditPage/editBloodNeeder.php?id= " .$row['ID'] ."&&from=1'><i class='fa fa-pencil-square-o' aria-hidden='true'></i>Edit</a>";
                                echo "<a class = 'table-delete' href = '../DeleteEntries/deleteNeeder.php?id= " .$row['ID'] ."&&from=1'><i class='fa fa-trash-o' aria-hidden='true'></i>Delete</a>";
                                echo "</div>";
                                echo "</td";
                                echo "</tr>";
                            }
