    ...
    <body>
        <section>
                ...
                <nav>
                    ...
                    <div class = "navigation">
                        <ul>
                            ...
                            <li> <a class="sbn" href = "userNeeders.php">Blood Recipients</a></li>
            ...
            <div class = "content" id = "content">
                <!-- Donor Page -->
                <div class= "donorPage">
                <h1>Blood Donor Entries</h1>
                <!-- compose button -->
                <div class = "href-cont">
                    <a href = "../CreatePage/createEntryDonor.php" class = "composeEntry">Compose an entry</a>
                </div>
                    <div class = "donor-table">
                        <div class = "userTable-container" id = "bloodDonorPage">
                            ...
                            <?php
                                ...
                                $query = "SELECT ID,FirstName,MiddleName,LastName,BloodType,FullAddress,City,Region,ContactDetails,Comments,Date FROM donortable WHERE Status != 'deleted' ORDER BY $order $sort";
                                ...
                                if ($result && mysqli_num_rows($result) > 0)
                                {
                                    while ($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        echo "<a class = 'table-see-details' href = '../ShowPage/donorDetail.php?id= " .$row['ID'] ."'><i class='fa fa-info-circle' aria-hidden='true'></i>See Details</a>";
                                        echo "<a class = 'table-delete' href = '../ReportPage/reportDonor.php?id= " .$row['ID'] ."&&from=0'><i class='fa fa-flag-o' aria-hidden='true'></i>Report</a>";
                                        echo "</div>";
                                        echo "</td";
                                        echo "</tr>";
                                    }
